...
_int CHUD_StarPoint::Tick(_float fTimeDelta)
{
	...
	{
		if (m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font100") || m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font100_Shadow"))
		{
			_uint iCount100 = stoi(m_UIObjDesc.wstrText);
			iCount100++;

			if (iCount100 > 9) iCount100 = 0;
			m_UIObjDesc.wstrText = to_wstring(iCount100);
		}
		if (m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font10") || m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font10_Shadow"))
		{
			_uint iCount10 = stoi(m_UIObjDesc.wstrText);
			iCount10++;

			if (iCount10 > 9) iCount10 = 0;
			m_UIObjDesc.wstrText = to_wstring(iCount10);
		}
		if (m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font1") || m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font1_Shadow"))
		{
			_uint iCount1 = stoi(m_UIObjDesc.wstrText);
			iCount1++;

			if (iCount1 > 9) iCount1 = 0;
			m_UIObjDesc.wstrText = to_wstring(iCount1);
		}
	}
...
HRESULT CHUD_StarPoint::Render()
{
	...
	if (UI_FONT == m_UIObjDesc.eUIType)
	{
		...
		if (m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font100_Shadow") || m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font10_Shadow")
			|| m_UIObjDesc.wstrUITag == TEXT("StarPoint_Font1_Shadow"))
