...
#pragma region MRT_LightAcc
	...
	if (FAILED(m_pGameInstance->Add_MRT(TEXT("MRT_LightAcc"), TEXT("Target_Specular"))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_MRT(TEXT("MRT_LightAcc"), TEXT("Target_SSAO"))))
		return E_FAIL;
#pragma endregion
...
HRESULT CRenderer::Render_SuperUI()
{
	...
	if (FAILED(m_pGameInstance->Bind_RTShaderResource(m_pShader, TEXT("Target_DeferredInfo"), "g_FinalTexture")))
		return E_FAIL;
