...
public:
	...
	static HRESULT Load_Effect(const path _FilePath, _Out_ SINGLE_FX_DATA* _pData);
	static HRESULT Load_Effect(const path _FilePath, _Out_ PARTICLE_DATA* _pData);
	static HRESULT Load_Effect(const path _FilePath, _Out_ MULTI_FX_DATA* _pData);
