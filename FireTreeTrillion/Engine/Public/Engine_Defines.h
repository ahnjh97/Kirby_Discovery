...
namespace Engine
{
    ...
    enum INSTANCE_PROPERTY { INSTANCE_DROP, INSTANCE_SPREAD, INSTANCE_DECELERATE, INSTANCE_APPEAR, INSTANCE_DISAPPEAR, INSTANCE_WIGGLE, INSTANCE_TAIL, INSTANCE_END };
