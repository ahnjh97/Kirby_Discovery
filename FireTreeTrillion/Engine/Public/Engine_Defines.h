...
namespace Engine
{
    ...
    enum RIGID_SHAPE { RIGID_BOX, RIGID_SPHERE, RIGID_CAPSULE, RIGID_CONVEXMESH, RIGID_END };
    enum INSTANCE_PROPERTY { INSTANCE_DROP, INSTANCE_SPREAD, INSTANCE_DECELERATE, INSTANCE_APPEAR, INSTANCE_DISAPPEAR, INSTANCE_WIGGLE, INSTANCE_TAIL,
        INSTANCE_GRAVITY, INSTANCE_ORBIT, INSTANCE_ASSEMBLE, INSTANCE_SIMPLEMOVE, INSTANCE_SPHERERANDOM, INSTANCE_ACCELERATION, INSTANCE_ORBITDECELERATE, INSTANCE_ORBITACCELERATION, 
        INSTANCE_COLORINTERPOLATE, INSTANCE_CUSTOMORBITAXIS, INSTANCE_TURN, INSTANCE_TURNMOVEDIR, INSTANCE_TURNACCELERATION, INSTANCE_TURNDECELERATE, INSTANCE_END };
    enum TIMER {TIMER_NONE, TIMER_FIRST, TIMER_SECOND, TIMER_END};
    enum INSTANCE_SHAPE { INSTANCE_SHAPE_SPHERE, INSTANCE_SHAPE_RECTANGLE, INSTANCE_SHAPE_END };
...
namespace Engine
{
	...
	enum CHANNELID {
		...
		CHANNEL_SOUND11, CHANNEL_SOUND12, CHANNEL_SOUND13, CHANNEL_GIMMICK, CHANNEL_GIMMICK_SUB,
        CHANNEL_BGM, CHANNEL_BGM_SUB, CHANNEL_BGM_STREAMING, CHANNEL_END
	};
}
