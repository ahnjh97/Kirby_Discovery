...
namespace Engine
{
    ...
    enum INSTANCE_PROPERTY { INSTANCE_DROP, INSTANCE_SPREAD, INSTANCE_DECELERATE, INSTANCE_APPEAR, INSTANCE_DISAPPEAR, INSTANCE_WIGGLE, INSTANCE_TAIL,
        INSTANCE_GRAVITY, INSTANCE_ORBIT, INSTANCE_ASSEMBLE, INSTANCE_SIMPLEMOVE, INSTANCE_SPHERERANDOM, INSTANCE_ACCELERATION, INSTANCE_ORBITDECELERATE, INSTANCE_ORBITACCELERATION, INSTANCE_END };
