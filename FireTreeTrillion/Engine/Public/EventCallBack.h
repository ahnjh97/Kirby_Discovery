...
public:
    ...
    void Register_Controller(PxActor* pActor, PxController* pController) { m_vecControllers.push_back({ pActor, pController }); }
...
private:
    ...
    vector<pair<PxActor*,PxController*>> m_vecControllers;
