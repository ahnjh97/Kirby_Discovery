...
public:
	...
	enum BRONTOBURTMOVING_STATE {
		BRONTOBURTMOVING_CIRCLE, BRONTOBURTMOVING_PATROL, BRONTOBURTMOVING_END
	};

	struct BRONTOBURT_DESC : public CMonster::MONSTER_DESC {
		BRONTOBURTMOVING_STATE eMoveState = { BRONTOBURTMOVING_END };
...
private:
	...
	BRONTOBURTMOVING_STATE	m_eMoveState = { BRONTOBURTMOVING_END };
