...
//			CUTSCENE STATE
//*********************************
class CFinaleBoss_CutScene_State final : public CFSM_State
{
private:
	CFinaleBoss_CutScene_State();
	virtual ~CFinaleBoss_CutScene_State() = default;
...
public:
	static	CFinaleBoss_CutScene_State* Create();
	virtual void Free() override;
};
