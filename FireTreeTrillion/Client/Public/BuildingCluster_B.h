...
class CBuildingCluster_B final : public CGameObject
{
private:
	CBuildingCluster_B(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBuildingCluster_B(const CBuildingCluster_B& rhs);
	virtual ~CBuildingCluster_B() = default;
...
public:
	static CBuildingCluster_B* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
