...
{
	//enum RABBIT_ANIM {
	//	RABBIT_DAMAGE, RABBIT_FIND, RABBIT_JAMPBIG, RABBIT_JUMP, RABBIT_JUMPATTACK, RABBIT_JUMPEND, RABBIT_JUMPENDBIG,
	...
	//	RABBIT_JUNMPLANDINGATTACK, RABBIT_JUNMPLANDINGBIG, RABBIT_JUMPLANDINGSMALL, RABBIT_JUMPSMALL, RABBIT_JUMPSTART, RABBIT_JUMPSTARTBIG, RABBIT_JUMPSTARTSMALL, RABBIT_LOOKAROUND, RABBIT_WAIT,
	//	RABBIT_END
	//};
