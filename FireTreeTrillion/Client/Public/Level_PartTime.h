...
BEGIN(Client)
class CLevel_PartTime final : public CLevel
{
private:
	CLevel_PartTime(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_PartTime() = default;
...
public:
	static CLevel_PartTime* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
