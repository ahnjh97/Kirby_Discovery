...
enum PASS_POSTEX {
    POSTEX_DEFAULT, POSTEX_ALPHABLEND, POSTEX_BLENDFX, POSTEX_BLOOM, POSTEX_DEFAULTFX, POSTEX_BLEND_NOZTEST, POSTEX_WHITEFX, POSTEX_UI_MASK, POSTEX_UI_MASK2, POSTEX_SOFTFX, POSTEX_END
};
