...
enum PASS_MODEL {
    ...
    MODEL_DEFAULTFX = 12, MODEL_BLENDFX, MODEL_WHITEFX_LINEARDIFFUSE, MODEL_WHITEFX_CLAMPDIFFUSE = 15, MODEL_UNKNOWN = 16,
    MODEL_END
};

enum PASS_MAP {
    MAP_NONBLEND_NORMAL_O, MAP_NONBLEND_NORMAL_X, MAP_LIGHTDEPTH, MAP_ALPHABLEND, MAP_NONBLEND_NONDISCARD, MAP_MASKED_NORMAL_O, MAP_END
};
