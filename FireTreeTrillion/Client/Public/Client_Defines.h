...
enum PASS_MAP {
    MAP_NONBLEND_NORMAL_O, MAP_NONBLEND_NORMAL_X, MAP_LIGHTDEPTH, MAP_BLEND_NORMAL_O, MAP_BLEND_NORMAL_X,
    MAP_NONBLEND_NONDISCARD, MAP_BLEND_NONDISCARD, MAP_MASKED_NORMAL_O, MAP_END
};
