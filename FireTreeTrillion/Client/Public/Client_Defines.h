...
enum PASS_ANIMMODEL {
    ...
    ANIMMODEL_KIRBY, ANIMMODEL_KIRBYMOUTH, ANIMMODEL_KIRBYEYE, ANIMMODEL_NEARCLIP, ANIMMODEL_LINEAR_NORMAL_O, ANIMMODEL_KIRBY_WEAPONS,
    ANIMMODEL_LINEAR_NORMAL_O_NONDISCARD = 14,
    ANIMMODEL_END
};
