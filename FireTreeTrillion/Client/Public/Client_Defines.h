...
enum PASS_POSTEX {
    POSTEX_DEFAULT, POSTEX_ALPHABLEND, POSTEX_BLENDFX, POSTEX_BLOOM, POSTEX_DEFAULTFX, POSTEX_BLEND_NOZTEST, POSTEX_WHITEFX, POSTEX_UI_MASK, POSTEX_UI_MASK2, POSTEX_SOFTFX, POSTEX_SOFTALPHAFX, POSTEX_END
};

enum PASS_MODEL {
    MODEL_NORMAL_O, MODEL_NORMAL_X, MODEL_SHADOW, MODEL_SKY, MODEL_BLOOM, MODEL_BLEND, MODEL_TRIGGER, 
    MODEL_DEFAULTFX, MODEL_BLENDFX, MODEL_DEFERREDINFO, MODEL_WHITEFX, MODEL_KIRBYPART,
    MODEL_END
};
...
enum PASS_ANIMMODEL {
    ...
    ANIMMODEL_KIRBY, ANIMMODEL_KIRBYMOUTH, ANIMMODEL_KIRBYEYE,
    ANIMMODEL_END
};
