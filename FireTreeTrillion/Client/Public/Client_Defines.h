...
enum PASS_POSTEX {
    ...
    POSTEX_FOCUSINGPOSITION, POSTEX_FADEINOUT, POSTEX_UIMWBASE_CLAW,
    POSTEX_END
};
...
enum PASS_MODEL {
    ...
    MODEL_DEFAULTFX = 12, MODEL_BLENDFX, MODEL_WHITEFX_LINEARDIFFUSE, MODEL_WHITEFX_CLAMPDIFFUSE = 15, MODEL_EMISSIVE_NORMAL_O, MODEL_EMISSIVE_NORMAL_X,
    MODEL_STAR,
    MODEL_END
};
