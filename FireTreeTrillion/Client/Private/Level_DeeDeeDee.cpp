...
HRESULT CLevel_DeeDeeDee::Ready_Layer_UI(const wstring& _wstrLayerTag)
{
	HRESULT hr;
	...
	hr = m_pGameInstance->Add_Clone(eLevel, TEXT("Layer_UI_MESSAGEWINDOW"), TEXT("Prototype_GameObject_UI_MessageWindow"), &MessageWindowDesc);
	hr = m_pGameInstance->Add_Clone(eLevel, TEXT("Layer_UI_MESSAGEWINDOW"), TEXT("Prototype_GameObject_UI_BtnIcon"));
...
HRESULT CLevel_DeeDeeDee::Load_FileData(const string& _strFilePath, FILE_TYPE _eFileType, const wstring& _wstrLayerTag)
{
