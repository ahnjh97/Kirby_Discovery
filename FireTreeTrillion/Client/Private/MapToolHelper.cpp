...
HRESULT CMapToolHelper::Initialize(void* pArg)
{
	...
	m_vecMapModelNames = { "Level0Stage1Step01", "Level1Stage1Step01", "Town", "TownShop", "LbLastBossStage"};
	m_setMapNames = { "BG0", "BG1", "Level0Stage1Step01", "Level1Stage1Step01", "Town" , "TownShop", "LbLastBossStage"};
