...
HRESULT CMapToolHelper::Initialize(void* pArg)
{
	...
	m_vecMapModelNames = { "Level0Stage1Step01","Level0Stage1Step02", "Level1Stage1Step01", "Town" };
	m_setMapNames = { "BG0", "BG1", "Level0Stage1Step01", "Level1Stage1Step01","Level0Stage1Step02", "Town" };
